...
permalink: /2009/07/17/advanced-java-reflection-framework-needs-a-good-enough-name/index.html
post_id: 119
categories: 
- Java
---
...
<pre name="code" class="java">public class A<V> {
...
<pre name="code" class="java">public class Event<S> {
