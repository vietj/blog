...
permalink: /2009/12/30/gatein-management/index.html
post_id: 152
categories: 
- GateIn
- Java
...
<pre name="code" class="java">@Managed
...
</pre>management returns a list of the managed services annotated with the @Rest annotation,
aka "resource list"
