...
{% highlight java %}@MixinType(name="templatized")
...
{% highlight java %}@PrimaryType(name="page")
...
{% highlight java %}Page page = session.findByPath(Page.class, "page");
...
templatized.setTemplate(template);{% endhighlight %}
