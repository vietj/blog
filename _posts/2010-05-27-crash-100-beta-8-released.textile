...
permalink: /2010/05/27/crash-100-beta-8-released/index.html
post_id: 188
categories: 
- GateIn
- Java
...
<div>The prompt command implementation required a refactor of the CRaSH architecture, the main challenge coming from the following facts:</div>
<div>
<ul>
...
<div>The refactoring was quite fun to do, and lead to a few improvements in the architecture that consisted mostly in decoupling the various systems, now we can distinguish:</div>
<div>
<ol>
...
<div>At the moment I am quite satisfied by the current features. I think it is still missing the command completion and I don't have a clue if it is easy or complex to do and which system should manage it, I'll leave it for later fun. Maybe it will be easy to do, or it could require some new important refactor to make it possible to happen, who knows?</div>
</div>
</div>